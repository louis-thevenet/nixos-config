...
# in
{
  ...
  #       Mod+colon { show-hotkey-overlay; }

  #       // Suggested binds for running programs: terminal, app launcher, screen locker.
  #       Mod+T { spawn "kitty"; }
  #       Mod+D { spawn "bash" "-c" "echo -n toggle | ${socat} - ~/.cache/albert/ipc_socket"; }

  #       XF86MonBrightnessUp allow-when-locked=true { spawn "${brightnessctl}"  "set" "+5%" "amdgpu_bl1";}
  #       XF86MonBrightnessDown allow-when-locked=true { spawn "${brightnessctl}"  "set" "-5%" "amdgpu_bl1";}
